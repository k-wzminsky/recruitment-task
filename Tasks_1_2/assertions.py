...
def compare_values(displayed_value: typing.Union[str, int], expected_value: typing.Union[str, int]) -> None:
...
def expected_in_displayed(expected_value: typing.Union[str, int], displayed_value: typing.Union[str, int, list]) -> None:
